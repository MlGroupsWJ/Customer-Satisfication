...
from EDA.EDA4 import train_data, test_data, IDlist
...
SaveResult(lrc, X, y, test_data, IDlist, '../Result/EDA4_LRC.csv')
SaveResult(svc, X, y, test_data, IDlist, '../Result/EDA4_SVC.csv')
SaveResult(dtc, X, y, test_data, IDlist, '../Result/EDA4_DTC.csv')
SaveResult(xgbc, X, y, test_data, IDlist, '../Result/EDA4_XGBC.csv')
